...
<head>
  ...
  <script src="https://kit.fontawesome.com/001c8e1e7e.js" crossorigin="anonymous"></script>
...
@section('content')
  <div class="jumbotron text-center">
    ...
    <a href="{{ url('/data-siswa') }}" class="btn btn-secondary">Data Siswa</a>
  </div>
@endsection
